...
The rest of the paper proceeds as follows. The following subsection gives an institutional and historical background of the paper's setting, Ecuador. Section 2 reviews the relevant literature. Section 3 develops the empirical methodology. Section 4 reviews the results from the empirical estimation. Section 5 discusses these results, and Section 6 concludes. 
